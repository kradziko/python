...
for poet, row, col, status in [('Ernest Hemingway',0,0,NORMAL),('Joseph Conrad',0,1,NORMAL),
                               ('Cyprian Norwid',1,0,DISABLED),('Allan Edgar Poe',1,1,NORMAL),
                               ('Adam Mickiewicz',2,0,NORMAL),('Julian Tuwim',2,1,NORMAL)]:
